...
const Skills = () => {
  return (
    ...
    <div id='skills' className='min-h-screen px-6 md:px-10 lg:px-18 pt-28 pb-10 border-b border-cyan-400'>
      ...
      <div className='flex flex-col gap-10'>
        ...
        <div className='flex flex-col lg:flex-row items-center justify-between gap-14 lg:gap-20'>
          ...
          <div className='flex-1 w-full'>
            ...
            <h2 className='inline-block text-xl md:text-2xl font-semibold border-b-2 border-cyan-400 text-cyan-400 mb-6 pb-1'>
              My Skills
            </h2>
            ...
            <p className='text-zinc-400 text-lg md:text-xl mt-8 leading-8 md:leading-9 max-w-xl'>
              Passionate about building scalable and modern web applications using the MERN stack with focus on clean architecture, performance and seamless user experiences.
            </p>
          ...
          <div className='flex-1 flex justify-center items-center w-full'>
            ...
            <img
              src={skillsIMG}
              alt="Skills"
              className='w-full max-w-[500px] h-[250px] md:h-[320px] object-cover rounded-3xl border border-cyan-400/30 shadow-2xl shadow-cyan-500/20 hover:shadow-cyan-500/60 transform duration-1000'
            />
        ...
        <div>
          ...
          <h2 className='inline-block text-xl md:text-2xl font-semibold border-b-2 border-cyan-400 text-cyan-400 mb-10 pb-1'>
            Technical Skills
          </h2>

          <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-8'>

            <div className='min-h-[280px] rounded-3xl border border-cyan-400 bg-slate-900/50 backdrop-blur-md'>
              <div className='flex justify-start items-center px-5 pt-5 pb-2 gap-5 text-lg md:text-xl border-b border-cyan-400'>
                <h2 className='text-cyan-400'><Laptop size={28}/></h2>
                <h2>FRONTEND</h2>
              </div>

              <div className='flex justify-start items-center pb-5 ps-5 gap-5 text-lg md:text-xl mt-5'>
                <h2 className='text-cyan-400'><FaHtml5 className='text-orange-500' size={28}/></h2>
                <h2>HTML5</h2>
              </div>

              <div className='flex justify-start items-center pb-5 ps-5 gap-5 text-lg md:text-xl'>
        ...
        <div className='flex items-center bg-slate-900/80 border-l-8 border-cyan-400 w-full py-4 px-6 rounded-2xl shadow-lg shadow-cyan-900'>
          <Star size={22}/>
          <h2 className='text-md md:text-lg font-medium ms-3'>
