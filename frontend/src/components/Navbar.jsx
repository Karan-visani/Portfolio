...
const Navbar = () => {
  return (
    <div className='fixed top-5 left-1/2 -translate-x-1/2 z-50 w-[95%] bg-slate-900/70 backdrop-blur-md border border-slate-800 flex justify-between items-center px-5 pt-3 pb-3 rounded-3xl shadow-2xl shadow-cyan-950/20'>
        ...
        <a href='/resume.pdf' download className='py-2 px-6 bg-cyan-400 rounded-xl hover:bg-cyan-500 hover:scale-105 text-md flex items-center gap-3 text-black font-semibold transition-all duration-300'>
            Resume
